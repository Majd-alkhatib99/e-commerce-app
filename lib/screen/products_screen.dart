...
class ProductsScreen extends StatelessWidget {
  ...
  final String title;
  final List<ProductsCategoryDataModel> products;
  ...
  Widget buildGridView(MainCubit cubit,List<ProductsCategoryDataModel> products,context){
  ...
  Widget buildItem(MainCubit cubit,List<ProductsCategoryDataModel> products,int index,context){
    return Padding(
